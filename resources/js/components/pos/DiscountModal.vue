                ...
                <div v-if="mode === 'voucher'" class="space-y-4">
                    ...
                    <div class="space-y-2 pt-2">
                        ...
                        <div 
                            v-for="v in vouchers" 
                            :key="v.id"
                            @click="handleSelectVoucher(v.code)"
                            class="p-3.5 rounded-2xl border border-slate-200 dark:border-zinc-800 hover:border-emerald-500 bg-slate-50/50 dark:bg-zinc-800/40 cursor-pointer transition-all flex items-center justify-between"
                        >
                            <div>
                            ...
                            <span class="px-3 py-1.5 bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 font-black rounded-xl text-[11px]">
                                Pilih
                            </span>
                        </div>
                    </div>
